...
/* harmony import */ var _modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/tabs/init-tabs */ "./js/modules/tabs/init-tabs.js");
...
/* harmony import */ var _vendor_lazysizes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/lazysizes */ "./js/vendor/lazysizes.js");
/* harmony import */ var _vendor_itc_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/itc-slider */ "./js/vendor/itc-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var video = document.querySelector('[data-validate="video"]');
  var youtube = document.querySelector('[data-validate="youtube"]');
  var slider = document.querySelectorAll('.itc-slider');
  var tabs = document.querySelector('[data-tabs="content"]');
  var reviews = document.querySelector('[data-validate="reviews"]');
  var reviewsSlider = reviews.querySelectorAll('.itc-slider__item');
  var sliderHeight = document.querySelector('[data-validate="slider-height"]');
  var onEnterKeydown = function onEnterKeydown(evt) {
    if (evt.key === 'Enter') {
      evt.preventDefault();
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (entry.target.classList.contains('itc-slider__item_active')) {
          ...
          sliderHeight.style.height = "".concat(height, "px");
        }
      }
    } catch (err) {
      _iterator.e(err);
  ...
  reviewsSlider.forEach(function (el) {
  ...
  window.addEventListener('load', function () {
    Object(_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_1__["initTabs"])();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_2__["Form"]();
    window.form = form;
    form.init();
    Object(_vendor_lazysizes__WEBPACK_IMPORTED_MODULE_3__["lazySizes"])();
    slider.forEach(function (el) {
      _vendor_itc_slider__WEBPACK_IMPORTED_MODULE_4__["ItcSlider"].getOrCreateInstance(el);
    });
  });
});
...
function _onResize2() {
  ...
  var btnSlider = document.querySelector('[data-validate="btn-slider"]');
